                ...
                <div className="flex-1 overflow-auto">
                    <TabsContent value="account" className="w-full">
                        <div className="flex flex-row gap-4">
                            <p className="font-medium text-lg ">Alta Prioridade</p>
                            <CirclePlus size={24} className="cursor-pointer hover:text-indigo-400" />
                        </div>
                    ...
                    <TabsContent value="password" className="w-full">
                        <div className="flex flex-row gap-4">
                            <p className="font-medium text-lg ">Alta Prioridade 2</p>
                            <CirclePlus size={24} className="cursor-pointer hover:text-indigo-400" />
                        </div>
