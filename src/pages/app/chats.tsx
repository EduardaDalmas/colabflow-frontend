                ...
                <div className='shadow-shape bg-zinc-800 mt-5 rounded-2xl flex-1 flex flex-col max-h-[600px] min-h-[600px]'>
                    ...
                    <div className='flex flex-col flex-1 overflow-auto'>
                        {messages.map((message, index) => (
                            <div
                                ...
                                } flex mb-2 items-center`} // 'items-center' alinha o avatar e a mensagem
                                key={index}
                            >
                        ...
                        <div ref={messagesEndRef} /> {/* Referência para o scroll */}
                    </div>
                    ...
                    <div className="relative flex items-center bg-zinc-950 border-zinc-800 rounded-xl w-full mt-5">
                        <Input 
                            ...
                            className="pl-5 pr-4 py-2 text-md rounded-2xl h-12 w-full border bg-transparent border-none shadow-shape" 
                        />
