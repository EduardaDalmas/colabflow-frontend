...
export function LandingPage() {
    ...
    return (
        <div className="relative h-screen overflow-hidden">
            ...
            />
            <div className="absolute top-40 left-1/2 transform -translate-x-1/2 text-center z-10 px-4 md:left-1/4 md:top-40">
                <h1 className="text-2xl md:text-3xl mb-16 max-w-md text-indigo-400 line-through">
                    Nunca mais perca o fio da meada nas suas interações.
                </h1>
            </div>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white z-10 px-4 md:top-2/3 md:left-1/4">
                <h1 className="text-sm md:text-lg mb-4 max-w-md leading-6 md:leading-7 font-extralight">
