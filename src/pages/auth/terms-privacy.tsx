            ...
            <div className="w-full md:px-6 text-left space-y-10 h-auto ">
                ...
                <div className='max-w-1/4'>
                    ...
                    <p className='font-light text-sm text-zinc-400 mb-5'>
                        Bem-vindo ao <strong>TaskFlow</strong>! Esses Termos de Serviço
                        ("Termos") regem o uso da nossa plataforma de comunicação colaborativa.
                        Ao acessar ou utilizar o <strong>TaskFlow</strong>, você concorda com
                    ...
                    <p className='font-light text-sm text-zinc-400 mb-5'>
                        Ao usar o <strong>TaskFlow</strong>, você concorda em cumprir e ser
                    ...
                    <p className='font-light text-sm text-zinc-400 mb-5'>
                        O <strong>TaskFlow</strong> se reserva o direito de alterar ou modificar
                        ...
                        do uso do <strong>TaskFlow</strong> após qualquer modificação constitui
                        aceitação dos Termos modificados.
                    </p>

                    <h2 className='font-medium text-md mb-2 text-zinc-300'>4. Uso da Plataforma</h2>
                    <p className='font-light text-sm text-zinc-400 mb-5'>
                        O <strong>TaskFlow</strong> deve ser usado exclusivamente para fins
                    ...
                    <p className='font-light text-sm text-zinc-400 mb-5'>
                        ...
                        conta. Você deve notificar imediatamente o <strong>TaskFlow</strong> em
                        caso de qualquer uso não autorizado da sua conta. O{' '}
                        <strong>TaskFlow</strong> não será responsável por perdas ou danos
                    ...
                    <p className='font-light text-sm text-zinc-400 mb-5'>
                        ...
                        <strong>TaskFlow</strong>. No entanto, ao compartilhar conteúdo, você concede
                        ao <strong>TaskFlow</strong> uma licença para armazenar e exibir esse conteúdo
                        conforme necessário para fornecer o serviço. O <strong>TaskFlow</strong> reserva-se
                    ...
                    <p className='font-light text-sm text-zinc-400 mb-5'>
                        O <strong>TaskFlow</strong> e todos os seus componentes, incluindo software,
                        design e conteúdo fornecido, são de propriedade exclusiva do <strong>TaskFlow</strong>
                        ou de seus licenciadores. Você não tem permissão para copiar, modificar, distribuir
                        ou vender qualquer parte do <strong>TaskFlow</strong> sem autorização prévia por escrito.
                    </p>

                    <h2 className='font-medium text-md mb-2 text-zinc-300'>8. Limitação de Responsabilidade</h2>
                    <p className='font-light text-sm text-zinc-400 mb-5'>
                        O <strong>TaskFlow</strong> não será responsável por quaisquer danos indiretos,
                        incidentais, especiais ou consequenciais decorrentes do uso da plataforma. Em
                        nenhuma circunstância a responsabilidade do <strong>TaskFlow</strong> excederá o valor
                    ...
                    <p className='font-light text-sm text-zinc-400 mb-5'>
                        O <strong>TaskFlow</strong> se reserva o direito de suspender ou encerrar sua conta
                    ...
                    <p className='font-light text-sm text-zinc-400 mb-5'>
                        O <strong>TaskFlow</strong> valoriza sua privacidade. Esta Política de Privacidade
                        descreve como coletamos, usamos e compartilhamos suas informações pessoais ao usar
                        a nossa plataforma de comunicação colaborativa. Ao utilizar o <strong>TaskFlow</strong>,
                    ...
                    <p className='font-light text-sm text-zinc-400 mb-5'>
                        ...
                        você utiliza o <strong>TaskFlow</strong> e a melhorar nossos serviços.
                    </p>
                    ...
                    <p className='font-light text-sm text-zinc-400 mb-5'>
                        ...
                        e pesquisa interna para aprimorar o <strong>TaskFlow</strong>.
                    </p>
                    ...
                    <p className='font-light text-sm text-zinc-400 mb-5'>
                        ...
                        <strong>TaskFlow</strong>, analisar o uso da plataforma e personalizar o conteúdo que
                        você vê. Você pode controlar o uso de cookies através das configurações do seu
                        navegador, mas algumas funcionalidades do <strong>TaskFlow</strong> podem ser afetadas
